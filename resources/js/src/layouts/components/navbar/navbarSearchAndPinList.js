...
export default {
  pages: {
    ...
    data: [
      // DASHBOARDS
      { title: "Catalogue", url: "/catalogue", icon: "HomeIcon", is_bookmarked: false },
      ...
      // { title: "User List", url: "/apps/user/user-list1", icon: "ListIcon", is_bookmarked: false },
      { title: "Liste des Utilisateurs", url: "/apps/user/user-list1", icon: "ListIcon", is_bookmarked: false },
      // { title: "Create Exams", url: "/createExams", icon: "PlusCircleIcon", is_bookmarked: false },
      { title: "Creer une épreuve", url: "/createExams", icon: "PlusCircleIcon", is_bookmarked: false },
      // { title: "Parent List", url: "/parents", icon: "ListIcon", is_bookmarked: false },
      { title: "Liste des Parents", url: "/parents", icon: "ListIcon", is_bookmarked: false },
      { title: "Liste des postulations", url: "/postulations", icon: "ListIcon", is_bookmarked: false },
      // { title: "Postulations List", url: "/postulations", icon: "ListIcon", is_bookmarked: false },
      { title: "Exportation", url: "/exportation", icon: "UploadIcon", is_bookmarked: false },
      { title: "Gestion des pays", url: "/pays", icon: "MenuIcon", is_bookmarked: false },
      { title: "Gestion des regions", url: "/regions", icon: "MenuIcon", is_bookmarked: false },
      { title: "Gestion des etablissements", url: "/etablissements", icon: "MenuIcon", is_bookmarked: false },
      { title: "Gestion des matieres", url: "/matieres", icon: "MenuIcon", is_bookmarked: false },
      { title: "Gestion des classes", url: "/classes", icon: "MenuIcon", is_bookmarked: false },
      { title: "Gestion des chapitres", url: "/chapitres", icon: "MenuIcon", is_bookmarked: false },
      { title: "Gestion des notions", url: "/notions", icon: "MenuIcon", is_bookmarked: false },
      { title: "Gestion des roles", url: "/gest2", icon: "MenuIcon", is_bookmarked: false },
      { title: "Gestion des Permissions", url: "/gestionpermissions", icon: "MenuIcon", is_bookmarked: false },
