...
export default [
...

    {
        ...
        icon: 'MenuIcon',
        i18n: 'Gestion des droits',
        submenu: [{
            url: '/gest2',
            name: 'Gestion Des Roles',
            icon: 'PlusCircleIcon',
            slug: 'Gestion Des Roles',
            i18n: 'Gestion Des Roles'
        },
        {
            url: '/gestionpermissions',
            name: 'Gestion Des Permissions',
            icon: 'PlusCircleIcon',
            slug: 'Gestion Des Permissions',
            i18n: 'Gestion Des Permissions'
        },
        ],
    },
    {
        ...
        icon: 'MenuIcon',
        i18n: 'Gestion des comptes',
        submenu: [{
            url: '/postulations',
            name: 'Gestion Des Postulations',
            slug: 'Gestion Des Postulations',
            i18n: 'Gestion Des Postulations'
        },
        {
            url: '/parents',
            name: 'Gestion Des Parent',
            slug: 'Gestion Des Parent',
            i18n: 'Gestion Des Parent'
        },
        ],
    },
    {
        url: null,
        name: 'Gestion de la platforme',
        icon: 'MenuIcon',
        i18n: 'Gestion de la platforme',
        submenu: [{
            url: '/pays',
            name: 'pays',
            slug: 'GererPays',
        ...
        },
        {
            ...
            name: 'regions',
            slug: 'GererRegions',
            i18n: 'Gerer les Regions'
        },
        {
            url: '/etablissements',
            name: 'GererEtablissements',
            slug: 'GererEtablissements',
            i18n: 'Gerer les etablissements'
        },
        {
            url: '/classes',
            name: 'GererClasses',
            slug: 'GererClasses',
            i18n: 'Gerer les classe'
        },
        {
            url: '/matieres',
            name: 'GererMatieres',
            slug: 'GererMatieres',
            i18n: 'Gerer les matieres'
        },
        {
            url: '/chapitres',
            name: 'GererChapitres',
            slug: 'GererChapitres',
            i18n: 'Gerer les Chapitres'
        },
        {
            url: '/notions',
            name: 'GererNotions',
            slug: 'GererNotions',
            i18n: 'Gerer les Notions'
        },
        ]
    },
    {
        url: '/exportation',
        name: 'Exportation des sujets',
        icon: 'ExternalLinkIcon',
        slug: 'Exportation des sujets',
        i18n: 'Exportation des sujets'
    },
