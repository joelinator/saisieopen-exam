...

        {
            ...
            children: [
                ...
                },
                {
                    path: '/catalogue',
                    name: 'catalogue',
                    component: () => import('@/views/ui-elements/data-list/list-view/Catalog.vue'),
                    meta: {
                        // breadcrumb: [{
                        //     title: 'Home',
                        //     url: '/'
                ...
                // ######======== CUSTOM USER LIST ========##########
                {
                    path: '/apps/user/user-list1',
                    name: 'app-user-list1',
                    component: () => import('@/views/apps/user/user-list/UserList1.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                {
                    path: '/apps/user/user-view1/:userId',
                    name: 'app-user-view',
                    component: () => import('@/views/apps/user/UserView1.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                {
                    path: '/apps/user/user-edit1/:userId',
                    name: 'app-user-edit',
                    component: () => import('@/views/apps/user/user-edit/UserEdit1.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
...

                {
                    path: '/createExams',
                    name: 'Create Exams',
                    component: () => import('@/views/epreuve/Create.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                },
                {
                    ...
                    component: () => import('@/views/GestionParents/ParentsList.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Parents' },
                            { title: 'Gestion des Parents', active: true }
                        ],
                ...
                },
                {
                    ...
                    name: 'parentId',
                    component: () => import('@/views/GestionParents/ParentId.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                    ...
                    props(route) {
                        return { data: route.query }
                    }
                },
                {
                    path: '/postulations',
                    name: 'Liste des postulations',
                    component: () => import('@/views/GestionComptes/Postulations.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Postulations' },
                            { title: 'Gestion des comptes', active: true }
                        ],
                        pageTitle: 'Postulations',
                        rule: 'editor'
                    }
                },
                {
                    path: '/postulations/:postulationId',
                    name: 'postulationId',
                    component: () => import('@/views/GestionComptes/PostulationId.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                },
                {
                    path: '/exportation',
                    name: 'Create',
                    component: () => import('@/views/exportation/Exportation.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Exportation' },
                            { title: 'Exportation des sujets', active: true }
                        ],
                ...
                },
                {
                    path: '/pays',
                    name: 'pays',
                    component: () => import('@/views/GestionPlateforme/GestionPays.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                },
                {
                    path: '/regions',
                    name: 'region',
                    component: () => import('@/views/GestionPlateforme/GestionRegion.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                },
                {
                    path: '/etablissements',
                    name: 'etablissements',
                    component: () => import('@/views/GestionPlateforme/GestionEtablissements.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                        ...
                        pageTitle: 'Gestion des etablissements',
                        rule: 'editor'
                    }
                },
                {
                    path: '/matieres',
                    name: 'matieres',
                    component: () => import('@/views/GestionPlateforme/GestionMatiere.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                },
                {
                    path: '/classes',
                    name: 'classes',
                    component: () => import('@/views/GestionPlateforme/GestionClasse.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                },
                {
                    path: '/chapitres',
                    name: 'chapitres',
                    component: () => import('@/views/GestionPlateforme/GestionChapitres.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                        ...
                        pageTitle: 'Gestion des chapitres',
                        rule: 'editor'
                    }
                },
                {
                    path: '/notions',
                    name: 'notions',
                    component: () => import('@/views/GestionPlateforme/GestionNotions.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                        ...
                        {
                            title: 'Gestion des notions',
                            active: true
                        }
                        ],
                        pageTitle: 'Gestion des notions',
                        rule: 'editor'
                    }
                },
                {
                    path: '/gest2',
                    name: 'Droits',
                    component: () => import('@/views/GestionDesDroits/gest2.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                {
                    path: '/gestionpermissions',
                    name: 'GestionPermissions',
                    component: () => import('@/views/GestionDesPermissions/GestionPermissions.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
                ...
                },
                {
                    path: '/exams/:examsId',
                    name: 'examsId',
                    component: () => import('@/views/epreuve/Exams.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Catalogue',
                            url: '/'
                ...
                },
                {
                    path: '/gestiondroits',
                    name: 'GestionDroits',
                    component: () => import('@/views/GestionDesDroits/GestionDroits.vue'),
                    meta: {
                        breadcrumb: [{
                            title: 'Home',
                            url: '/'
