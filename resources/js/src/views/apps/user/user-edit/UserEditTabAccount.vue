    ...
    <div class="vx-row">
      <div class="vx-col md:w-1/2 w-full">
        <vs-input
          class="w-full mt-4"
          label="Username"
          v-model="data_local.account_name"
      ...
      <div class="vx-col md:w-1/2 w-full">
        ...
        <div class="mt-4">
          <vs-input
            ...
            v-model="data_local.date_naissance"
            type="date"
            v-validate="'required|email'"
            name="DOB"
          />
...
export default {
  ...
  computed: {
    ...
    // },
    data() {
      return this.$store.state.userManagement.users.find((element) => {
        return element.id == this.Pdata.id;
      });
    },
    role_local: {
      get() {
        if (this.data_local.role[0] != undefined) {
          return {
            label: this.capitalize(this.data_local.role[0].name),
