...
<template>
  <div id="page-user-list">
    <data-user-sidebar @closeSidebar="toggleDataSidebar" :isSidebarActive="addNewDataSidebar" />
    <vx-card
      ref="filterCard"
      title="Filters"
    ...
    <div class="vx-card p-6">
      <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex flex-wrap">
          <div class="flex-grow pb-3 sm:pb-0 sm:pr-3">
          ...
          <div
            class="btn-add-new p-3 ml-3 mb-4 sm:mr-4 rounded-lg cursor-pointer flex items-center justify-center text-lg font-medium text-primary border border-solid border-primary"
            @click="addNewData"
          >
        ...
        <div class="flex flex-wrap">
          ...
          <!-- ACTION - DROPDOWN -->
          <vs-dropdown vs-trigger-click class="cursor-pointer ml-3 md:ml-0">
            <div
...
import DataUserSidebar from "./DataUserSidebar.vue";
...
export default {
  ...
  methods: {
    ...
    reziseAgridView() {
      if (window.innerWidth > 650) this.gridApi.sizeColumnsToFit();
    },
  },
  destroyed() {
    window.removeEventListener("resize", this.reziseAgridView);
  },
  mounted() {
    this.gridApi = this.gridOptions.api;
    //fit widhts to size and remove horizontal scroll
    this.gridApi.sizeColumnsToFit();

    window.addEventListener("resize", this.reziseAgridView);
